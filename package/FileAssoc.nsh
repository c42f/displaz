...
; Written by Saivert
;
; Source URL: http://nsis.sourceforge.net/FileAssoc
;
...
!macro APP_UNASSOCIATE EXT FILECLASS
  ; Restore backup of the previously associated file class
  ClearErrors
  ReadRegStr $R0 HKCR ".${EXT}" `${FILECLASS}_backup`
  ; If we don't find the backup, assume APP_ASSOCIATE wasn't called
  ; due to an option in the installer
  IfErrors +2 0
  WriteRegStr HKCR ".${EXT}" "" "$R0"
  DeleteRegKey HKCR `.${EXT}\${FILECLASS}_backup`
