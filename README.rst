...
Windows x64
~~~~~~~~~~~
The windows releases are built using the Visual Studio 2013 x64 command prompt.
...
Next, in the x64 cross tools command prompt::
    ...
    rem Build displaz.
    rem Assumes that Qt has been installed into C:\Qt\Qt5.5.1\5.5\msvc2013_64
    mkdir build
    cd build
    cmake -G "NMake Makefiles" ^
        -D CMAKE_PREFIX_PATH=C:\Qt\Qt5.5.1\5.5\msvc2013_64 ^
